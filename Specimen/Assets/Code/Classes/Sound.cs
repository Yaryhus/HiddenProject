...
public class Sound
{
    ...
    private string fmodFile = null;
    private EventInstance instance;
    [SerializeField]
    private List<ParamRef> parameters = null;
    ...
    public void PlayOneShot(Transform transform)
    {
        RuntimeManager.PlayOneShot(fmodFile, transform.position);
    }
